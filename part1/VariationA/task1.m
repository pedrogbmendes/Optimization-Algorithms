...
for L=1:1:length(lambda)
    ...
    % solve optimization problem for this lambda
    cvx_begin quiet
    ...
    save_str = strrep(str,'.',',');
    saveas(figure(1), strcat('Figures/task1/lambda_',save_str , '_position.pdf'));
    saveas(figure(2), strcat('Figures/task1/lambda_', save_str, '_control.pdf'));
